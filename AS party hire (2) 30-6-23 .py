...
def print_entry():
    ...
    while x < entered_count["entries"]:
        ...
        Label(main_window,text= customers[x][2],width = 5).grid(row=row, column=7, sticky= W)
        Label(main_window,text= customers[x][3],width = 5).grid(row=row, column=8 , sticky= E)
...
def main():
    ...
    Button(main_window, text="append",command=add_customer, width = 5).grid(row=0, column=1, padx=30)    
    ...
    Label(main_window, text="", width = 5).grid(row=4, column=0)
